...
class MoviesSeriesVC: UIViewController, MovieDetailsViewModelDelegate {
    ...
    let segmentedDetails = SegmentedMoviesDetailsVC()
    ...
    func setTrendsLabel() {
        ...
        trendsLabel.snp.makeConstraints { (make) -> Void  in
            ...
            trendsLabel.font = UIFont.boldSystemFont(ofSize: 30)
...
extension MoviesSeriesVC: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        moviesCell.layer.cornerRadius = 15
        
        return moviesCell
    }
    
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        segmentedDetails.movieID = String(trendsViewModel.array[0].results[indexPath.row].id)
        self.present(segmentedDetails, animated: true, completion: nil)
    }
