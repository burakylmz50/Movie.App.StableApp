//
//  SegmentedMoviesDetailsVC.swift
//  MoviesApplication
//
...
class SegmentedMoviesDetailsVC : UIViewController{
    ...
    private var MDM = [MoviesSegmentedModel]()
    ...
    private func paddingCastStackView(){
        castStackView.backgroundColor = .black
    ...
    func atamalarYapilacak(){
        ...
        if(TRM[0].results?.count != 0){
            if(TRM[0].results![0].key != nil){
        ...
        moviesDetailsViewModel.segmentedMoviesArray.removeAll()
        trailersViewModel.segmentedTrailersArray.removeAll()
        moviesCastViewModel.segmentedMovieCastArray.removeAll()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        trailerKey.removeAll()
        moviesDetailsViewModel.getDataSegmented(id: movieID) {}
        moviesCastViewModel.getSegmentedCast(id: movieID) {}
        trailersViewModel.getSegmentedDatagetData(id: movieID)
        MDM = moviesDetailsViewModel.segmentedMoviesArray
        TVM = trendsViewModel.array
        TRM = trailersViewModel.segmentedTrailersArray
        MCM = moviesCastViewModel.segmentedMovieCastArray
